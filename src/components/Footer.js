    ...
    <div className='container text-start'>
        <div className='row'>
            <div className='col-12 col-md-6 col-xl-3 mb-5'>
                <h3 className='text-start text-info'><img className='col-10'src={logo}></img></h3>
            ...
            <div className='col-12 col-md-6 col-xl-3 mb-5'>
                <h3 className='text-start text-info'><i class="fa-solid fa-building pe-1"></i>Branches</h3>
                <div><a>Toronto</a></div>
            ...
            <div className='col-12 col-md-6 col-xl-3 mb-5'>
                <h3 className='text-start text-info'><i class="fa-solid fa-clock pe-1 "></i>Working Hours</h3>
                <div className='row'>
            ...
            <div className='col-12 col-md-6 col-xl-3 mb-5 px-2 m-0'>
                <h3 className='text-start text-info'><i class="fa-solid fa-envelope pe-1"></i>Subscribe</h3>
